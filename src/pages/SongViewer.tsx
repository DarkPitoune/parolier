                ...
                >
                  {strophe.content.map((line, lineIndex) => (
                    ...
                    <Fragment key={lineIndex}>
                      {showChords && (
                        <DynamicText
                          className="bg-jubilateBlue-100 dark:bg-slate-600 outline-8 border-jubilateBlue-100 dark:border-slate-600 border-4 text-black dark:text-white first:rounded-t-md [&:nth-last-child(2)]:rounded-b-md"
