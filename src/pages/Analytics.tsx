...
function Analytics() {
	...
	const [analytics, setAnalytics] = useState<PopularSongs>([]);
				...
				<div className="flex flex-col gap-3 sm:gap-4">
					<div className="flex flex-wrap gap-2 items-center">
						...
						<div className="relative group">
							<InformationCircleIcon className="w-5 h-5 text-jubilateBlue-400 dark:text-jubilateBlue-300" />

							<div className="pointer-events-none group-hover:pointer-events-auto absolute bg-black bg-opacity-0 inset-0">
								<div className="relative w-[90vw] max-w-lg sm:max-w-2xl mt-12 sm:mt-16 pointer-events-auto opacity-0 group-hover:opacity-100 transition-opacity duration-200">
									<div className="p-4 bg-white dark:bg-jubilateBlue-900 rounded-lg border border-jubilateBlue-200 dark:border-jubilateBlue-700 shadow-lg">
										<h3 className="text-base sm:text-lg font-semibold text-jubilateBlue-700 dark:text-jubilateBlue-200 mb-0 flex items-center gap-2">
											Comment compte-t-on les vues ?
										</h3>
										<p className="text-sm text-gray-700 dark:text-gray-300">
											Une vue est comptée lorsque l'on ouvre la page d'un chant
											pendant plus de{" "}
											<span className="font-semibold">30 secondes</span>, avec
											une connexion internet.
											<br />
											<span className="italic text-gray-500 dark:text-gray-400">
												Les statistiques peuvent être légèrement biaisées (on
												n'ouvre pas un chant qu'on connait).
											</span>
										</p>
									</div>
								</div>
